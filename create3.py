...
# python create3.py /path/to/your/video_directory
# If you omit the directory argument, it defaults to the current working directory:
...
if __name__ == "__main__":
    ...
    with open("index.html", "w", encoding="utf-8") as f:
        f.write(html)
    print(f"index.html generated successfully from directory: {base_dir}")
